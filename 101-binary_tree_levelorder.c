...
/**
 * binary_tree_level - this performs a function on a specific level of a binary tree
...
/**
 * binary_tree_levelorder - this traverses a binary tree using level-order traversal
